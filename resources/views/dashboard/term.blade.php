...
@section('content')
<form action="{{ route('term') }}" method="POST">
    @csrf
    <textarea id="summernote" name="description">@isset($term){{ $term->description }}@endisset</textarea>
    <button type="submit" class="btn btn-primary">Create Terms</button>
</form>
